...
- **Rule Priority:** P0 (CONTINUE.md) > P1 (Agent .md) > P2 (SKILL.md). All rules are binding.
...
| 2 | Did I READ the agent's `.md` file (or recall its rules)? | STOP. Open `.continue/agents/{agent}.md` |
...
| Task | Read |
|------|------|
| Web UI/UX | `.continue/agents/frontend-specialist.md` |
| Mobile UI/UX | `.continue/agents/mobile-developer.md` |

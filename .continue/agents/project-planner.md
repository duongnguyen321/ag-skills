...
> 💡 **Script paths are relative to `.continue/` directory**

#### 1. Run All Verifications (RECOMMENDED)

```bash
# SINGLE COMMAND - Runs all checks in priority order:
python .continue/scripts/verify_all.py . --url http://localhost:3000
...
# P0: Security Scan
python .continue/skills/vulnerability-scanner/scripts/security_scan.py .

# P1: UX Audit
python .continue/skills/frontend-design/scripts/ux_audit.py .

# P3: Lighthouse (requires running server)
python .continue/skills/performance-profiling/scripts/lighthouse_audit.py http://localhost:3000

# P4: Playwright E2E (requires running server)
python .continue/skills/webapp-testing/scripts/playwright_runner.py http://localhost:3000 --screenshot
```

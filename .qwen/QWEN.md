# QWEN.md - Qwen Code Kit

> Persistent instructions & project context for Qwen Code.
...
| 2 | Did I READ the agent's `.md` file (or recall its rules)? | STOP. Open `.qwen/agents/{agent}.md` |
...
- Agents: `.qwen/agents/` (Project)
- Skills: `.qwen/skills/` + `.qwen/skills/` (Project)
- Commands: `.qwen/commands/` (Project)
...
|------------|---------|---------|
| **Manual Audit** | `python .qwen/scripts/checklist.py .` | Priority-based project audit |
| **Pre-Deploy** | `python .qwen/scripts/checklist.py . --url <URL>` | Full Suite + Performance + E2E |
...
| Task | Read |
|------|------|
| Web UI/UX | `.qwen/agents/frontend-specialist.md` |
| Mobile UI/UX | `.qwen/agents/mobile-developer.md` |
...
- **Verify**: `.qwen/scripts/verify_all.py`, `.qwen/scripts/checklist.py`
...
Settings are loaded hierarchically (highest priority first):
...
> Project settings override user settings. Use `settings.local.json` for personal overrides (gitignore).

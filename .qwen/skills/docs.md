...
| ------------- | --------------------------------- | ------------------------------------ |
| **Workspace** | `<workspace-root>/.qwen/skills/` | Available only in a specific project |
...
```bash
mkdir -p .qwen/skills/license-header-adder/resources
```

### Step 2: Create the template file

**`.qwen/skills/license-header-adder/resources/HEADER.txt`**:
...
**`.qwen/skills/license-header-adder/SKILL.md`**:
